...
/* Quantized Convolution Registers */
#define IP_CONV_MULTIPLIER_OFFSET   0x20u
#define IP_CONV_SHIFT_OFFSET        0x24u

#define IP_CONV_MULTIPLIER ((volatile int32_t*)(IP_CONV_BASE + IP_CONV_MULTIPLIER_OFFSET))
#define IP_CONV_SHIFT      ((volatile int32_t*)(IP_CONV_BASE + IP_CONV_SHIFT_OFFSET))
